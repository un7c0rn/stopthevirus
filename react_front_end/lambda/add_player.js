...
/******/ 	return __webpack_require__(__webpack_require__.s = "./add_player.js");
/******/ })
/************************************************************************/
/******/ ({
...
exports.handler = async (event, context, callback) => {
  try {
    ...
    const response = await _src_services_Firestore__WEBPACK_IMPORTED_MODULE_0__["default"].add_player({
      game: body.game,
      tiktok: body.tiktok,
      email: body.email,
