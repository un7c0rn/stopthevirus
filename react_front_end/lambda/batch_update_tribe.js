...
/***/ "../src/services/Firestore.js":
/*!************************************!*\
>>>>>>> Firestore game API update. Firestore tests. Lambda function.
  !*** ../src/services/Firestore.js ***!
  \************************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony import */ var dotenv__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
            /*! dotenv */ "dotenv"
          );
          /* harmony import */ var dotenv__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/ __webpack_require__.n(
            dotenv__WEBPACK_IMPORTED_MODULE_1__
          );
...
>>>>>>> Firestore game API update. Firestore tests. Lambda function.
          ...
          _defineProperty(Firestore, "initialise", () => {
            ...
            Firestore.firestore = Object(
              firebase_admin__WEBPACK_IMPORTED_MODULE_0__["firestore"]
            )(app);
            return {
              firebase: firebase_admin__WEBPACK_IMPORTED_MODULE_0___default(),
              firestore: Firestore.firestore,
          ...
          _defineProperty(
            Firestore,
            "count_players",
            async ({ game = null, from_tribe = null, from_team = null }) => {
              if (from_tribe) {
                return (
                  await Firestore.firestore
                ...
                return (
                  await Firestore.firestore
                    .doc(`games/${game}/teams/${from_team}`)
                    .get()
                ).data().count_players;
              } else {
                return (
                  await Firestore.firestore.doc(`games/${game}`).get()
                ).data().count_players;
              }
            }
          );
          ...
          _defineProperty(
            ...
            async ({
              ...
              if (from_tribe) {
                query = Firestore.firestore.doc(
                  `games/${game}/tribes/${from_tribe}`
                );
              } else {
          ...
          _defineProperty(
            Firestore,
            "batch_update_tribe",
            async ({ game = null, from_tribe = null, to_tribe = null }) => {
              const teams = Firestore.firestore
                .collection(`games/${game}/teams`)
                .where("tribe_id", "==", from_tribe);
              const players = Firestore.firestore
              ...
              let ref = Firestore.firestore.doc(
                `games/${game}/tribes/${to_tribe}`
              );
...
>>>>>>> Firestore game API update. Firestore tests. Lambda function.
          ...
          exports.handler = async (event, context, callback) => {
            try {
              ...
              _src_services_Firestore__WEBPACK_IMPORTED_MODULE_0__[
                "default"
              ].initialise();
              const response = await _src_services_Firestore__WEBPACK_IMPORTED_MODULE_0__[
                "default"
              ].batch_update_tribe({
                game: body.game,
                from_tribe: body.from,
